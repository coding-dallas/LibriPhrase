...
def get_parser():
  ...
  parser.add_argument('--libripath', type=str, default='/home/kesav/Documents/kesav/research/code_files/LibriPhrase/database/LibriSpeech_clean_wav/', help='Folder for LibriSpeech ASR corpus with wav files')
  parser.add_argument('--newpath', type=str, default='/home/kesav/Documents/kesav/research/code_files/LibriPhrase/database/LibriPhrase_diffspk_all/', help='Folder to save generated LibriPhrase wav files')
  parser.add_argument('--wordalign', type=str, default='/home/kesav/Documents/kesav/research/code_files/LibriPhrase/metadata/librispeech_clean_train_100h_all_utt.csv', help='word alignment file (csv format)')
  parser.add_argument('--output', type=str, default='/home/kesav/Documents/kesav/research/code_files/LibriPhrase/metadata/libriphrase_diffspk_all.csv', help='output filename (csv format)')
...
def main(args):
  ...
  for i in range(1, max_num_words + 1):
    ...
    print('* Time check: ', (time.time() - start_time) / (60 * 60), 'hours')
